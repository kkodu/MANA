			...
			<td>
				<table width="100%">
					...
					<tr class="hdr-tr">
						...
						<td><input class="input" name="password" type="password" size="50" maxlength="100" autofocus></td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr align="center" height="60">
						<td>&nbsp;</td>
						<td colspan="2">
							<input class="btn" type=button value="삭제" OnClick="javascript:deleteCheck();">

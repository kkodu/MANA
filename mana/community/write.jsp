...
<style>
	* { margin: 0; padding: 0; }
	...
	body { width: 772px; margin: 0 auto; }
			...
			<td>
				<table width="100%">
					...
					<tr class="hdr-tr">
						...
						<td><input class="input" name="title" size="50" maxlength="100" autofocus></td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr class="hdr-tr">
						...
						<td><input class="input" name="name" size="50" maxlength="50"></td>
						<td>&nbsp;</td>
					</tr>
					<tr height="2" bgcolor="#dddddd"><td colspan="4" width="100%"></td></tr>
					<tr class="hdr-tr">
						...
						<td><input class="input" name="password" size="50" maxlength="50"></td>
						<td>&nbsp;</td>
					</tr>
					<tr height="2" bgcolor="#dddddd"><td colspan="4" width="100%"></td></tr>
					<tr id="hdr-memo" class="hdr-tr">
						...
						<td><textarea class="memo" name="memo" cols="50" rows="13"></textarea></td>
						<td>&nbsp;</td>
					</tr >
					...
					<tr align="center" height="60">
						<td>&nbsp;</td>
						<td colspan="2">
							<input class="btn" type=button value="등록" OnClick="javascript:writeCheck()">
